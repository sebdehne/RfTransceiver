...
public class GetStorageFanSpeedEndpoint extends AbstractRestHandler {

    private final StorageFanSpeedController storageFanSpeedController;

    public GetStorageFanSpeedEndpoint(StorageFanSpeedController storageFanSpeedController) {
    ...
    public void handle(String requestURI, List<String> fields, Map<String, String[]> params, JSONObject body, BiConsumer<Integer, Object> onDone) {
        onDone.accept(200, new JSONObject().put("value", storageFanSpeedController.getCurrentLevel()));
    }
}
